...
class SlackAlertChannel(
    ...
    override val type = AlertChannelType.SLACK
    ...
    override fun send(target: String, payload: JsonNode): ChannelSendOutcome {
        val body: ObjectNode = objectMapper.createObjectNode().put("text", buildText(payload))
    ...
    private fun buildText(payload: JsonNode): String = buildString {
        ...
        val ruleCode = payload.path("ruleCode").asText("alert")
