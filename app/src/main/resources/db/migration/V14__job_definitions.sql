...
CREATE INDEX idx_job_executions_running     ON job_executions (status) WHERE status = 'RUNNING';
CREATE INDEX idx_job_executions_pending     ON job_executions (status) WHERE status = 'PENDING';
